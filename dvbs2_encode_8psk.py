...
class dvbs2_encode_8psk(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Dvbs2 Encode 8Psk", catch_exceptions=True)
        ...
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_char*1, '/home/daniel/contracting/grcon23-ctf/bbframes_8psk.u8', False, 0, 0)
        self.blocks_file_source_1.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/daniel/contracting/grcon23-ctf/8psk910_plframes.c64', False)
...
def main(top_block_cls=dvbs2_encode_8psk, options=None):
    tb = top_block_cls()
